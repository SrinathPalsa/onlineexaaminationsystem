...
public class AQuesucuc extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			int i = st.executeUpdate("update mquestions set question='" + quest
					+ "',choice1='" + ch1 + "',choice2='" + ch2 + "',choice3='"
					+ ch3 + "',choice4='" + ch4 + "',choice5='" + ch5
					+ "',answer='" + ans + "' where (lang='" + lan
			...
			out.println("<a href='http://localhost:8089/servlet/AQuesu'>");
