...
public class getquest extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		 ...
		 * lang=(String)ois.readObject(); } catch(Exception e) { }
		 */
		...
		try {
			...
			rs1 = st.executeQuery("select sub_code from msubjectinfo where sub_title='"
					+ lang + "'");
			rs1.next();
			// code=rs1.getString(1);
			rs = st.executeQuery("select * from mquestions where lang='"
					+ rs1.getString(1) + "'");
			while (rs.next()) {
